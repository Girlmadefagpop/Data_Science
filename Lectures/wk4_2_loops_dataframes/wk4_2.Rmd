...
# Drop in session - Thurs 3-4pm
# 52 Pritchatts Road - G16 (main lecture theatre)
...
def simulate_jury(percent_black):
    ...
    np.random.choice(size=12,p=[.26,.74])
```

```{python}
import numpy as np
np.random.choice([1,0],size=12,p=[.26,.74])
```
